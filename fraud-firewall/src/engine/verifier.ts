// CONSTITUTION: v5.2.7 — Triple Verifier & Report Generator
...
function generateText(report: ForensicReport): string {
  ...
  lines.push(`Engine: v5.2.9 | Constitution: v5.2.7`);
  lines.push("");
  ...
  lines.push("\n" + "=".repeat(70));
  lines.push("END OF REPORT — Seal: VO-CE-v529 | Constitution: v5.2.7");
  lines.push("=".repeat(70));
...
function generateMarkdown(report: ForensicReport): string {
  ...
  lines.push("\n---");
  lines.push(`*Generated by Verum Omnis Contradiction Engine v5.2.9 under Constitution v5.2.7*`);
